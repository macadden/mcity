                 ...
                 <div>
                    <Paper>
                        <Table>
                            ...
                            <TableBody>
                                {this.state.players ? //Si tengo jugadores, hago algo (loopearlos)
                                    this.state.players.map((player, i) => ( /**-"match.date" viene del server */
                                        <TableRow key={i}>
                                            <TableCell>
                                    ...
                                    : null //Si no tengo jugadores, devuelvo null.
